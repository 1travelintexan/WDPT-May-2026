...
function booksByAuthor(dict) {
  ...
  for (author in dict) {
    const authorBooksArray = dict[author];
    authorBooksArray.forEach((oneBook) => {
      const authorBookTitle = oneBook[0];
      const authorBookPages = oneBook[1];
      const newBook = {
        title: authorBookTitle,
        pages: authorBookPages,
        author: author,
      };
  ...
  //return the new array of formatted books
